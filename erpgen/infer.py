...
Flat party sheets (Customer Name + inline contact/address columns) have no
single doctype and are reported as None regardless of file name — callers route
them to the parties flow instead.
"""
from __future__ import annotations

from typing import Optional

from .parties import is_parties_sheet
